...
{
    public RenderTexture myRt1;
    public RenderTexture myRt2;
    public RenderTexture myRt3;
    ...
    void OnRenderImage(RenderTexture source,RenderTexture destination)
    {
        ...
        myRt1=_renderTextureDepth;

        _camera.fieldOfView = _mainCamera.fieldOfView;
        _camera.aspect = _mainCamera.aspect;
        _camera.RenderWithShader (_depthShader,string.Empty);
        _materialOcclusion.SetTexture("_MainTex",_renderTextureDepth);
